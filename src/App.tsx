    ...
    <div className="app">
      ...
      <section className="info">
        <div className="left-info">
          ...
          <p>
            It offers a wide range of content <br /> related to space tourism, including <br />
          ...
          <div className="bottom-row">
            ...
            <div className="icons">
              <div className="planet-1">
                🪐 <span>Journey to the <br /> red planet</span>
              </div>
              <div className="planet-2">
                🌕 <span>journey to the <br /> moon</span>
              </div>
        ...
        <div className="right-cards">
          <div className="space-card">
            ...
            <div className="text">
              <strong>01</strong>
              <p>Jupiter is the 5<sup>th</sup> planet from the sun.
              </p>
              <button>More</button>
            </div>
          </div>
          ...
          <div className="space-card">
            ...
            <div className="text">
              <strong>02</strong>
              <p>Neptune is the 8<sup>th</sup> planet from the sun</p>
              <button>More</button>
            </div>
          </div>
        </div>
